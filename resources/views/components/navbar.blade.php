...
<header class="navbar" id="navbar" role="banner">
    ...
    <div class="navbar__strip">
        <div class="container navbar__strip-inner">
            <div class="navbar__strip-left">
                ...
                <span class="navbar__strip-text">{{ __('messages.nav.open_hours') }}</span>
            </div>
        ...
        <div class="container navbar__main-inner">
            ...
            <a href="{{ route('home') }}" class="navbar__logo" aria-label="Soly Clinic — Home">
                ...
                <div class="navbar__logo-text">
                    ...
                    <span class="navbar__logo-tagline">{{ __('messages.nav.tagline') }}</span>
                </div>
            </a>
    ...
    <div class="navbar__mobile" id="mobileMenu" aria-hidden="true" role="dialog" aria-label="Mobile navigation">
        <nav class="navbar__mobile-nav">
            <a href="{{ route('home') }}" class="navbar__mobile-link">{{ __('messages.nav.home') }}</a>
            <a href="{{ route('services') }}" class="navbar__mobile-link">{{ __('messages.nav.services') }}</a>
            <a href="{{ route('doctors') }}" class="navbar__mobile-link">{{ __('messages.nav.doctors') }}</a>
            <a href="{{ route('gallery') }}" class="navbar__mobile-link">{{ __('messages.nav.gallery') }}</a>
            <a href="{{ route('contact') }}" class="navbar__mobile-link">{{ __('messages.nav.contact') }}</a>
        </nav>
