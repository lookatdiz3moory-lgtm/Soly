...
<section class="hero" id="hero" aria-label="Welcome to Soly Clinic">
  ...
  <div class="hero__bg" aria-hidden="true">
    <div class="hero__bg-photo" style="background-image:url('{{ asset('images/hero-bg.jpg') }}')"></div>
  ...
  <div class="container hero__inner">
    ...
    <div class="hero__content">
      ...
      <h1 class="hero__headline" data-animate="fade-up" data-delay="80">
        {{ __('messages.hero.headline_l1') }}<br>
        <em>{{ __('messages.hero.headline_l2') }}</em><br>
        {{ __('messages.hero.headline_l3') }}
      </h1>
      ...
      <div class="hero__stats" data-animate="fade-up" data-delay="320">
        <div class="hero__stat">
          ...
          <span class="hero__stat-label">{{ __('messages.hero.stat_patients') }}</span>
        </div>
        ...
        <div class="hero__stat">
          ...
          <span class="hero__stat-label">{{ __('messages.hero.stat_experience') }}</span>
        </div>
        ...
        <div class="hero__stat">
          ...
          <span class="hero__stat-label">{{ __('messages.hero.stat_rating') }}</span>
        </div>
      </div>
    </div>

    {{-- ── RIGHT: Floating appointment card ────────────────────── --}}
    <div class="hero__visual" data-animate="fade-left" data-delay="120">
      <div class="hero__card">
        <div class="hero__card-header">
          <div class="hero__card-icon">🦷</div>
          <div>
            <div class="hero__card-title">{{ __('messages.hero.card_title') }}</div>
            <div class="hero__card-sub">{{ __('messages.hero.card_sub') }}</div>
          </div>
          <div class="hero__card-badge">{{ __('messages.hero.card_badge') }}</div>
        </div>
        ...
        <a href="{{ route('booking') }}" class="btn btn--primary btn--full hero__card-cta">
          {{ __('messages.hero.card_cta') }}
        </a>
      </div>

      {{-- Micro-floating badges --}}
      <div class="hero__float hero__float--1">{{ __('messages.hero.float_no_fees') }}</div>
      <div class="hero__float hero__float--2">★★★★★</div>
      <div class="hero__float hero__float--3">{{ __('messages.hero.float_safe') }}</div>
    </div>
  ...
  <div class="hero__scroll" aria-hidden="true">
    ...
    <span class="hero__scroll-text">{{ __('messages.hero.scroll') }}</span>
  </div>
