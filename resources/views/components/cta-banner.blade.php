  ...
  <div class="container">
    <div class="cta-banner__card" data-animate="fade-up">
      ...
      <div class="cta-banner__content">
        <div class="section-tag" style="margin-bottom:var(--sp-4)">{{ __('messages.cta.tag') }}</div>
        <h2 class="cta-banner__title" id="cta-heading">
          {{ __('messages.cta.title_l1') }}<br>{{ __('messages.cta.title_l2') }}
        </h2>
